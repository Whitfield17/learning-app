...
class ContentModel: ObservableObject {
    ...
    func checkLogin() {
        ...
        //Check if theres a current user to determine logged in status
    ...
    func getLessons(module: Module, completion: @escaping () -> Void) {
        ...
        collection.getDocuments { (snapshot, error) in
            ...
            if error == nil && snapshot != nil {
                ...
                //Loop through published modules array and find the one that matches the id of the copy
                //that got passed in
    ...
    func beginTest(_ moduleId: String) {
        ...
        //Reset the lessonIndex since they are starting a test
        currentLessonIndex = 0
        
        //If there are questions set the current question tot he first one
